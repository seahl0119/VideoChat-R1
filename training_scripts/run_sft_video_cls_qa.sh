...
srun torchrun --nproc_per_node="8" \
    ...
    --train_data_path your_base_dir/VideoEval/Quality_Access/annotations/Quality_Access_100shot.json \
    --eval_data_path your_base_dir/VideoEval/Quality_Access/annotations/Quality_Access_100shot.json \
    --video_folder your_base_dir/VideoEval/Quality_Access/videos \
    --dataset_name xxx \
